...
# Check current volume (now about 10%)
$Volume = [Audio]::Volume         

# See if speaker is muted
$Muted = [Audio]::Mute

if ($Muted) 
{
    Print-FomattedEvent("Audio is in a muted state.")
}
else
{
    Print-FomattedEvent("Audio is NOT in a muted state.")
}
